package com.chakray.chilcano.wso2.rabbitmq.message.store;
...
public class RabbitMQStore extends AbstractMessageStore {
    ...
    // Publ: BURL:direct://amq.direct//?routingkey='chakray_rk_queue1'
    public static final String DESTINATION_PUBLISHER = "store.jms.destinationPublisher"; 
    // Cons: BURL:direct://amq.direct/chakray_rk_queue1/chakray_queue1
    ...
    public MessageProducer getProducer() {
        ...
        // TODO The JmsProducer was replaced for RabbitMQProducer
    ...
    public MessageConsumer getConsumer() {
        ...
        // TODO The JmsConsumer was replaced for RabbitMQConsumer
    ...
    private boolean initSystemProps(){
    	...
    	try {
            ...
            // TODO System props were defined to avoid incompatibilities with RabbitMQ
    ...
    private boolean initme() {
        ...
        for (Map.Entry<String, Object> e : mapSet) {
            if (e.getValue() instanceof String) {
                ...
                logger.debug("initme() ~ properties(" + e.getKey() + ") : " + properties.get(e.getKey()));
            }
        }
        ...
        // TODO DestionationConsumer created to manage compatibility with RabbitMQ
        ...
        try {
            ...
            // TODO Created to manage compatibility with RabbitMQ
    ...
    private InitialContext newContext() {
        ...
        try {
            ...
            // TODO Consumer is placed into a table
